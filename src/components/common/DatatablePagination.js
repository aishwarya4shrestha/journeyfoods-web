...
export default class DataTablePagination extends Component {
  ...
  render() {
    const { page, pages, canPrevious, canNext, pageSizeOptions, showPageSizeOptions, showPageJump } = this.props;
          ...
          {showPageJump && (
            <div className="float-left pt-2">
              ...
              <UncontrolledDropdown className="d-inline-block">
                ...
                <DropdownMenu direction="left">{this.renderPageJump()}</DropdownMenu>
              </UncontrolledDropdown>
              <span> of </span>
              {pages}
            </div>
