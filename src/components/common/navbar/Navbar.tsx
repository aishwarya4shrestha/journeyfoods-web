...
import { REPORT, HOME } from '../../../constants/routes';
  ...
  return (
    <nav className="navbar">
      ...
      <ul className="navbar__menu navbar__menu--primary">
        ...
        <NavLink activeClassName="active" className="menu-item" exact={true} to={HOME}>
          <i /> <span className="menu-item-link">Dashboard</span>
        </NavLink>
        <li className="menu-item">
          <a href="" className="menu-item-link">
            Ingredients
