...
import { getAllReports, createReport, editReport } from '../../../service/api/admin.service';
...
class EditReport extends React.Component<IAdminProps, IAdminState> {
  ...
  render() {
    ...
    const { allReports, selectedReport } = this.props;
    const option = {
...
const mapStateToProps = (store: any) => {
  const {
    adminReducer: { allReports, selectedReport }
  } = store;
  return {
    allReports,
    selectedReport
